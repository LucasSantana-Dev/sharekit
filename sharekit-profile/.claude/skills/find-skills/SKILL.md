---
name: find-skills
description: Discover relevant installable skills from the available skill ecosystem
  and suggest the best fit for the user request. Use when the user asks whether a
  skill exists, wants help finding one, or wants to extend the agent with a new capability.
metadata:
  owner: global-agents
  tier: contextual
---
