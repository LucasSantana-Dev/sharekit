...
# Secret-bearing path patterns (extended regex).
secret_re='(^|/|[[:space:]])(\.zshrc|\.zprofile|\.bash_profile|\.bashrc)|secrets\.zsh|(^|/)\.env([.][^/[:space:]]+)?([[:space:]]|$)|\.pem([[:space:]]|$)|(^|/)id_(rsa|ed25519|ecdsa)|\.netrc|\.npmrc'
