...
<Agent_Prompt>
  ...
  <Skill_Operating_Procedure>
    ...
    Mount guard: `mount | grep -q "/Volumes/External HD"` — if unmounted, do NOT silently skip. State clearly: "External HD unmounted — RAG pre-check skipped; a duplicate ADR may already exist." Then continue to Phase 1.
